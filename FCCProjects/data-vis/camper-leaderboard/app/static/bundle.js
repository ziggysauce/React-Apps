...
var _Leaderboard = __webpack_require__(59);
...
var App = function (_Component) {
	...
	function App(props) {
		...
		_this.getAllTime = _this.getAllTime.bind(_this);
		_this.getRecent = _this.getRecent.bind(_this);
		return _this;
	}
	...
	_createClass(App, [{
		...
		value: function getRecent() {
			...
			_axios2.default.get('https://fcctop100.herokuapp.com/api/fccusers/top/recent').then(function (results) {
				var recentData = results.data;
				_this2.setState({
					data: recentData
				});
			}).catch(function (err) {
		...
		value: function getAllTime() {
			...
			_axios2.default.get('https://fcctop100.herokuapp.com/api/fccusers/top/alltime').then(function (results) {
				var recentData = results.data;
				_this3.setState({
					data: recentData
				});
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(_Leaderboard2.default, { data: this.state.data, getAllTime: this.getAllTime.bind(this), getRecent: this.getRecent.bind(this) }),
...
var _leaderboard = __webpack_require__(60);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('i', { className: 'fab fa-free-code-camp fa-lg fc-logo' })
          )
        ),
        _react2.default.createElement(
          'table',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'button',
                  { className: 'toggle-score', onClick: function onClick(e) {
                      return _this2.props.getRecent(e);
                    } },
                  'Points (past 30 days)'
                )
              ),
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'button',
                  { className: 'toggle-score', onClick: function onClick(e) {
                      return _this2.props.getAllTime(e);
                    } },
                  'Points (all time)'
                )
              )
            ...
            this.props.data.map(function (user, index) {
              return _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement('img', { src: user.img, width: '40px' }),
                  _react2.default.createElement(
                    'a',
...
// module
exports.push([module.i, ".leaderboard-container {\n  border: 1px solid #b8b8b8;\n  font-family: 'Fira Sans Extra Condensed', sans-serif;\n  width: 90vw;\n  margin: 3em 0em; }\n  .leaderboard-container h1 {\n    text-align: center;\n    background: #136613;\n    color: #F8F8F8;\n    padding: 10px 0px;\n    margin-top: 0; }\n  .leaderboard-container .fc-logo {\n    color: #F8F8F8;\n    padding: 0px 5px;\n    transition: 0.3s; }\n    .leaderboard-container .fc-logo:hover {\n      color: #52371e; }\n  .leaderboard-container table {\n    width: 100%;\n    border-spacing: 0; }\n  .leaderboard-container td {\n    text-align: center;\n    padding: 10px 0px;\n    margin: 0; }\n    .leaderboard-container td :nth-of-type(1) {\n      border-radius: 50%;\n      vertical-align: middle; }\n    .leaderboard-container td img {\n      margin-right: 20px; }\n  .leaderboard-container .user-display {\n    text-align: left;\n    padding-left: 20px; }\n    .leaderboard-container .user-display a {\n      color: #141414;\n      text-decoration: none; }\n      .leaderboard-container .user-display a:hover {\n        color: #136613; }\n  .leaderboard-container th {\n    background: #F8F8F8;\n    color: #52371e;\n    font-size: 1.5em; }\n  .leaderboard-container tr:nth-child(odd) {\n    background: #b8b8b8; }\n  .leaderboard-container .toggle-score {\n    cursor: pointer;\n    border: none;\n    outline: none;\n    background: transparent;\n    color: #52371e;\n    font-family: 'Fira Sans Extra Condensed', sans-serif;\n    font-size: 1em;\n    font-weight: bold;\n    padding: 10px;\n    transition: 0.3s; }\n    .leaderboard-container .toggle-score:hover {\n      color: #136613;\n      transition: 0.3s; }\n", ""]);
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('i', { className: 'fab fa-linkedin social-icon' })
            )
          ),
          _react2.default.createElement(
            'li',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('i', { className: 'fab fa-github social-icon' })
            )
          ),
          _react2.default.createElement(
            'li',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('i', { className: 'fab fa-codepen social-icon' })
            )
          ),
          _react2.default.createElement(
            'li',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('i', { className: 'fab fa-medium social-icon' })
            )
          )
        ),
        _react2.default.createElement(

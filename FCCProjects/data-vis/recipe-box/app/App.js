...
class App extends Component {
    ...
    try {
      ...
      if (recipes) {
				console.log('local storage has recipes');
        this.setState((prevState) => ({
					recipes: prevState.recipes.concat(recipes)
				}));
      } else {
				console.log("local storage has no recipes");
  ...
  componentDidUpdate(prevProps, prevState) {
    if ((prevState.recipes.length !== this.state.recipes.length) || (prevState.recipes !== this.state.recipes)) {

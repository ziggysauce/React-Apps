		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'h4',
					null,
					'Shows current cryptocurrency exchange rates (USD).'
				),
...
var _crypto = __webpack_require__(37);
...
var Crypto = function (_Component) {
	...
	function Crypto() {
		...
		var _this = _possibleConstructorReturn(this, (Crypto.__proto__ || Object.getPrototypeOf(Crypto)).call(this));
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./crypto.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./crypto.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".crypto-container {\n  min-width: 60vw;\n  height: 100%;\n  padding: 10px; }\n", ""]);

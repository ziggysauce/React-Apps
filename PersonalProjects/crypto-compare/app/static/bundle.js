		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'h4',
					null,
					'Cryptocurrency exchange rates (USD). Percentage change over last 24 hours.'
				),
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'a',
						{ href: 'https://www.cryptocompare.com/api', target: '_blank' },
						'CryptoCompare'
					)
				),
  ...
  _createClass(Card, [{
    ...
    value: function componentDidMount() {
      ...
      fetch('https://min-api.cryptocompare.com/data/pricemultifull?fsyms=BTC,ETH,LTC,XRP,DASH,XMR,XEM,BCH&tsyms=USD').then(function (results) {
        ...
        var exchange = [];
        var coinType = ['BTC', 'ETH', 'LTC', 'XRP', 'DASH', 'XMR', 'XEM', 'BCH'];

        coinType.forEach(function (type) {
          exchange.push({

...
*/
var aa=__webpack_require__(2),l=__webpack_require__(13),B=__webpack_require__(7),C=__webpack_require__(4),ba=__webpack_require__(14),da=__webpack_require__(15),ea=__webpack_require__(16),fa=__webpack_require__(17),ia=__webpack_require__(18),D=__webpack_require__(8);
...
var _Ask = __webpack_require__(62);

var _Ask2 = _interopRequireDefault(_Ask);

var _Answer = __webpack_require__(65);
  ...
  _createClass(App, [{
    ...
    value: function getData() {
      ...
      _axios2.default.get('https://opentdb.com/api.php?amount=1&type=multiple').then(function (results) {
        var triviaData = results.data.results[0];
        var data = [{
          'category': triviaData.category,
          'question': { __html: triviaData.question },
          'choices': [{ __html: triviaData.correct_answer }, { __html: triviaData.incorrect_answers[0] }, { __html: triviaData.incorrect_answers[1] }, { __html: triviaData.incorrect_answers[2] }],
          'correct': { __html: triviaData.correct_answer }
        }];

        var randomize = data[0].choices;
        var position = randomize.length,
            temp = void 0,
            random = void 0;
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Session2.default, { results: this.state, resetSession: this.resetSession.bind(this) }),
...
// module
exports.push([module.i, ".trivia-section {\n  padding: 0;\n  margin: 0;\n  text-align: center; }\n  .trivia-section h1 {\n    font-size: 6em;\n    font-family: 'Pacifico', sans-serif;\n    margin: 0;\n    color: #141414; }\n", ""]);
...
var _ask = __webpack_require__(63);
...
var Ask = function (_Component) {
  ...
  function Ask() {
    ...
    var _this = _possibleConstructorReturn(this, (Ask.__proto__ || Object.getPrototypeOf(Ask)).call(this));
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'p',
            null,
            this.props.data.triviaData[0].category
          ),
          _react2.default.createElement(
            'h2',
            null,
          ...
          _react2.default.createElement('p', { dangerouslySetInnerHTML: this.props.data.triviaData[0].question })
        )
      );
    }
  }]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./ask.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./ask.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".question-section {\n  width: 80vw;\n  text-align: center; }\n  .question-section h3 {\n    padding: 0;\n    margin: 0;\n    font-size: 1.5em; }\n  .question-section h2 {\n    padding: 0;\n    margin: 10px 0px 0px 0px;\n    font-size: 2em; }\n  .question-section h3, .question-section h2 {\n    color: #416b9b; }\n  .question-section p {\n    color: #000;\n    font-weight: 700;\n    margin: 5px; }\n", ""]);
...
var Answer = function (_Component) {
  ...
  _createClass(Answer, [{
    ...
    value: function showAnswer() {
      var choices = document.querySelectorAll('.choices-container button');
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./answer.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./answer.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              { onClick: function onClick(e) {
                  return _this2.props.resetSession();
                } },
              'Reset'
            )
          )
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./session.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./session.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".session-section .session-container {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n  flex-wrap: wrap;\n  width: 70vw;\n  padding-top: 30px; }\n\n.session-section .progress {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  padding: 0px 30px; }\n  .session-section .progress h3 {\n    margin: 0;\n    font-size: 1.5em;\n    text-decoration: underline; }\n\n.session-section .record {\n  display: flex;\n  flex-direction: row; }\n\n.session-section .correct, .session-section .incorrect {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  margin: 10px 20px; }\n  .session-section .correct p:first-of-type, .session-section .incorrect p:first-of-type {\n    font-weight: 700;\n    text-transform: uppercase; }\n  .session-section .correct p, .session-section .incorrect p {\n    padding: 5px;\n    margin: 0; }\n\n.session-section .correct p:first-of-type {\n  color: #6ab04c; }\n\n.session-section .incorrect p:first-of-type {\n  color: #eb4d4b; }\n\n.session-section .reset button {\n  outline: none;\n  border: none;\n  border-bottom: 2px solid #914948;\n  border-radius: 3px;\n  background: linear-gradient(#ff7979, #eb4d4b);\n  color: #FFF;\n  transition: 0.3s;\n  box-shadow: 2px 2px 2px #1f0c0c;\n  font-size: 1em;\n  padding: 10px 20px;\n  text-transform: uppercase;\n  cursor: pointer; }\n  .session-section .reset button:hover {\n    transition: 0.3s;\n    background: linear-gradient(#eb5d5d, #d8413e); }\n  .session-section .reset button:active {\n    transform: translateY(5px);\n    border-bottom: 1px solid #914948;\n    box-shadow: 1px 1px 1px #1f0c0c; }\n", ""]);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'a',
              { href: 'https://www.linkedin.com/in/daniel-nguyen-1a041495/', target: '_blank' },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'a',
              { href: 'https://github.com/ziggysauce', target: '_blank' },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'a',
              { href: 'https://codepen.io/ziggysauce/', target: '_blank' },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'a',
              { href: 'https://medium.com/@ziggysauce', target: '_blank' },
